...
class API:
    ...
    def locate_agent(self):
        ...
        conn.request("GET", "/aip2pgaming/api/rl/gw.php?type=location&teamId=1410", payload, headers)
    ...
    def get_runs(self):
        ...
        conn.request("GET", "/aip2pgaming/api/rl/score.php?type=runs&teamId=1410&count=10", payload, headers)
        res = conn.getresponse()
        data = res.read()
        print(data.decode("utf-8"))
    ...
    def get_score(self):
        ...
        conn.request("GET", "/aip2pgaming/api/rl/score.php?type=score&teamId=1410", payload, headers)
        res = conn.getresponse()
        data = res.read()
        print(data.decode("utf-8"))
